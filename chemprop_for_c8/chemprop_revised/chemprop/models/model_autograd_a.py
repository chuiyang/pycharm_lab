...
from .mpn_autograd_a import MPN_a
...
class MoleculeModel_autograd_a(nn.Module):
    ...
    def __init__(self, classification: bool, multiclass: bool, aleatoric: bool, epistemic: str):
        ...
        """
        super(MoleculeModel_autograd_a, self).__init__()
...
def build_model_autograd_a(args: Namespace) -> nn.Module:
    ...
    model = MoleculeModel_autograd_a(classification=args.dataset_type == 'classification',
                                     multiclass=args.dataset_type == 'multiclass', aleatoric=args.aleatoric, epistemic=args.epistemic)
