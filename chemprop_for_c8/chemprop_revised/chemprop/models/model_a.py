...
class MoleculeModel_a(nn.Module):
    ...
    def __init__(self, classification: bool, multiclass: bool, aleatoric: bool, epistemic: str):
        ...
        """
        super(MoleculeModel_a, self).__init__()
...
def build_model_a(args: Namespace) -> nn.Module:
    """
    ...
    model = MoleculeModel_a(classification=args.dataset_type == 'classification', multiclass=args.dataset_type == 'multiclass', aleatoric=args.aleatoric, epistemic=args.epistemic)
