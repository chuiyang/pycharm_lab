...
class MPNEncoder(nn.Module):
    ...
    def forward(self,
        ...
        print('f_atoms', f_atoms, f_atoms.shape)
        print('f_bonds', f_bonds, f_bonds.shape)
        # print('a2b', a2b)
        # print('b2a', b2a)
        # print('b2revb', b2revb)
        ...
        print('input', input, input.shape, f_bonds.shape)
        message_0 = self.act_func(input)  # num_bonds x hidden_size
        print('message', message_0, message_0.shape)
        print('\n\n')
        ...
        for depth in range(self.depth - 1):  # GCNN
            ...
            nei_a_message = index_select_ND(message_0, a2b)  # num_atoms x max_num_bonds x hidden
            a_message = nei_a_message.sum(dim=1)  # num_atoms x hidden
            rev_message = message_0[b2revb]  # num_bonds x hidden
